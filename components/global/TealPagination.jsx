...
const TealPagination = ({ totalPages, currentPage, setCurrentPage }) => {
  ...
  const roundButtonClasses =
    "w-8 h-8 flex items-center justify-center rounded-md text-sm font-semibold transition-colors duration-200";
  ...
  const PageItem = ({ pageNum }) => {
    ...
    return (
      <button
        ...
        className={`${roundButtonClasses} mx-1 ${
          isActive
    ...
    <div className="flex justify-center p-4 font-inter">
      <nav className="flex items-center space-x-2">
        ...
        <button
          ...
          className={`${roundButtonClasses} bg-white ${baseColor} border ${borderColor} disabled:opacity-50 disabled:pointer-events-none hover:border-gray-500`}
