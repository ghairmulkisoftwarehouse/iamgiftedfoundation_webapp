...
import EventInformation   from './sponsorshipInformation/sponsorshipInformation';
...
const RegisterSponsorshipPage = async({ params }) => {
  ...
  title="Buy Tickets"
  height="h-[250px]"
  bannerSvgClass="w-[190px] lg:w-[210px] xl:w-[270px]"
/>
