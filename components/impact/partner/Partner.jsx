...
const Partner = () => {
  return (
    <div className="  mt-16  ">
    <div className='px-5 md:px-3.5  md:container mx-auto pt-6'>
...
<div className="flex gap-0.5 w-full justify-center">
       ...
       <button className="btn-animated   bg-white w-full xs:w-[160px] h-[50px]   group cursor-pointer relative overflow-hidden hover:border-[#8bc9c8]">
